...
- Провёл более 1900 часов курсов, тренингов и вебинаров;
- Учил и подготовил более 700 разработчиков;
- А ещё и к.ф.-м.н.
...
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
| ![Google Chrome](assets/icons/trim/google_chrome.png) | ![ts](assets/icons/trim/ts.png) | ![v8](assets/icons/trim/v8.png) | ![rxjs](assets/icons/trim/rxjs.png) | ![redux](assets/icons/trim/redux.png) |  |
...
# Спасибо за внимание!
.black[ 
## Пожалуйста, пройдите [опрос](https://otus.ru/polls/16652/)
## в личном кабинете 
]
